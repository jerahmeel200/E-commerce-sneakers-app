  ...
  return (
    <>
      <div className=" relative h-auto w-auto flex flex-col">
        ...
        lg:h-[75] md:h-[65vh] sm:h-[55vh] w-auto
         absolute top-0 left-0 right-0 opacity-100 z-10
          "
        ></div>
        <div
        ...
        >
          ...
          >
            ...
            sm:text-3xl xsm:text-2xl font-extrabold filter 
            ...
            <div
              className="grid items-center absolute top-[33vh]
          ...
          <div className="">
            <img
              ...
              className="w-auto h-[45vh] lg:h-[35vh] md:h-[31vh]
               sm:h-[21vh] xsm:h-[19vh] transitions-theme
                 -rotate-[24deg] hover:rotate-0 cursor-pointer
                  object-fill  "
            />
          </div>
        </div>
