    ...
    <>
      <div
        className={`flex items-center justify-between lg:flex-col
         lg:justify-center nike-container mt-10
          ${ifExists ? "flex-row-reverse" : "flex-row"}`}
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center md:justify-center">
        ...
        <div className="flex items-center md:justify-center justify-center max-w-xl relativen lg:max-w-none w-full">
          <img
            src={img}
            alt={`img/flex-content ${heading}`}
